module github.com/marksteve/silk/desktop

go 1.17

require (
	github.com/marksteve/silk/store v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/charmbracelet/charm v0.12.0 // indirect
...
replace github.com/marksteve/silk/store => ../store
